...
import {EventModel, Session} from "./event.model";
...
export class EventService {
  ...
  getEvents(): Observable<EventModel[]> {
    return this.http.get<EventModel[]>('/api/events')
      .pipe(catchError(this.handleError<EventModel[]>('getEvents', []))) // forwarded in proxy
  ...
  saveEvent(event): Observable<{} | EventModel> {
    ...
    return this.http.post<EventModel>('/api/events', event, options).pipe(catchError(this.handleError('saveEvent')));
  }

  searchSession(sessionName) {
    return this.http.get<Event[]>('/api/events/sessions/search?search=' + sessionName)
      .pipe(catchError(this.handleError<Event[]>('searchSession')))
  }
}
